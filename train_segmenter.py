...
def split_and_resize(images, labels, test_ratio, input_shape=(512, 512, 1), auto_resize=False, index_first=False, log=None):
    ...
    training_set = ImageSet(images=train_images, labels=train_labels, mode="segment", index_first=index_first)
    validation_set = ImageSet(images=test_images, labels=test_labels, mode="segment", index_first=index_first)
